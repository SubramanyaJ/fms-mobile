              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Center(
                      child: Padding(
                        padding: const EdgeInsets.only(right: 30.0), // Adjust the left padding as needed
                        child: const Text(
                          'Profile',
                          style: TextStyle(
                            color: Colors.white,
                ...
                child: Column(
                  children: [
                    ...
                    _buildOption(Icons.headset_mic, 'About Software', () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => const AboutSoftwarePage()),
                      );
                    }),
